...
import type { SubjectCategory, SubjectType } from "shared";
...
export const CATEGORY_CONFIG: Record<SubjectCategory, CategoryConfig> = {
  ...
  Language: {
    ...
    borderColor: "border-green-300 dark:border-green-700/60",
...
export function getCategoryConfig(
  ...
  return CATEGORY_CONFIG[category as SubjectCategory] ?? CATEGORY_CONFIG.Other;
}
